...
#define LOWFREQ          1   // working at low freq
//#define DIAG             0   // Hardware diagnostics on startup (only disable when your rig is working)
//#define KEYER            0   // CW keyer
//#define CAT              0   // CAT-interface
#define F_XTAL    26000030   // 27MHz SI5351 crystal
...
#define CW_MESSAGE       0   // Transmits pre-defined CW messages on-demand (left-click menu item 4.2)
